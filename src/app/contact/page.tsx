...
const contacts = [
  ...
  { title: "IT and Platform", value: "support@campusnexus.edu", detail: "Portal access, systems support, and operational assistance." },
];
    ...
    <PublicWrapper>
      <section className="px-6 py-16">
        <div className="mx-auto max-w-7xl space-y-10">
          <PageHeader eyebrow="Contact" title="Reach the right office with confidence." description="Campus Nexus supports clear communication channels for applicants, students, faculty, and administrative stakeholders." />
            ...
            <Card>
              ...
              <form className="mt-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <textarea rows={5} className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none placeholder:text-slate-500 focus:border-blue-400/60" placeholder="Write your message here..." />
                </div>
