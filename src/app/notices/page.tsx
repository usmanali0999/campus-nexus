    ...
    <PublicWrapper>
      <section className="px-6 py-16">
        <div className="mx-auto max-w-7xl space-y-10">
          <PageHeader eyebrow="Official Notices" title="Institutional updates, circulars, and announcements." description="A central notice stream for academic, administrative, and student-facing communication." />
              ...
              <Card hover key={notice.id}>
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center gap-3 text-xs">
                    ...
                    <span className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium ${getPriorityColor(notice.priority)}`}>{notice.priority} Priority</span>
