              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-slate-200">{department.dean}</p>
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-[0.18em] text-slate-500">
                      Programs
                    </p>
                    <p className="mt-2 text-sm text-slate-200">{department.programs}</p>
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-[0.18em] text-slate-500">
                      Students
                    </p>
                    <p className="mt-2 text-sm text-slate-200">{department.students}</p>
                  </div>
                </div>
              </div>
            </Card>
