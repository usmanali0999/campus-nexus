  ...
  return (
    <footer className="border-t border-white/10 bg-slate-950/40">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-4">
        <div className="md:col-span-1">
          ...
          <p className="mt-4 max-w-xs text-sm leading-6 text-slate-400">
            A modern university CMS and operations platform designed for
            academic institutions at enterprise scale.
          </p>
        </div>

        <div>
          <h4 className="mb-4 text-xs font-semibold uppercase tracking-[0.18em] text-slate-300">
            Navigation
          </h4>
      ...
      <div className="border-t border-white/10 px-6 py-5 text-center text-xs text-slate-500">
        © {new Date().getFullYear()} Campus Nexus. Built with Next.js — All
        rights reserved.
      </div>
    </footer>
  );
